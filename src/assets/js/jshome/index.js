...
jQuery(document).ready(function($){
	...
	var $project_caption = $('.projects-container');

	//on scolling, show/animate timeline blocks when enter the viewport
	$(window).on('scroll', function(){
		$project_caption.each(function(){
			if( $(this).offset().top <= $(window).scrollTop()+$(window).height()*0.75 && !($(this).find('li').hasClass('is-loaded')) ) {
